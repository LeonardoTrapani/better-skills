...
export interface NodePreviewData {
  ...
  showResourceContentPreview?: boolean;
}
...
export function NodePreviewCard({ data, className }: NodePreviewCardProps) {
  ...
  const showResourceContentPreview = data.showResourceContentPreview ?? false;
  const shouldShowContentPreview = isSkill || showResourceContentPreview;
        ...
        <div className="flex items-start justify-between gap-2 min-w-0">
          <div className="flex items-center gap-2 min-w-0">
            <div className="flex size-6 shrink-0 items-center justify-center rounded-sm border border-border bg-muted/50">
              ...
              ) : data.previewUnavailable && showResourceContentPreview ? (
