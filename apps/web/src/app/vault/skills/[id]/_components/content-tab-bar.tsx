...
export function ContentTabBar({
  ...
  return (
    <div className="flex items-stretch overflow-x-auto bg-background scrollbar-none" role="tablist">
      {tabs.map((tab) => {
        ...
        return (
          <div
            key={tab.id}
            className={cn(
              "group relative flex shrink-0 border-r border-border text-[11px] font-mono transition-colors duration-150",
              isActive
          ...
          >
            ...
            {!isSkillTab && (
              <button
                ...
                className={cn(
                  "absolute right-2 top-1/2 inline-flex -translate-y-1/2 items-center justify-center p-0.5 transition-colors",
                  isActive
